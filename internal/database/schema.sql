...
-- This schema stores all configuration previously in YAML files
-- Designed for Technitium-style primary/secondary sync
...
-- Stores key-value pairs for simple config values
...
CREATE TABLE IF NOT EXISTS upstream_servers (
    ...
    priority INTEGER NOT NULL, -- Lower is higher priority (0 = primary)
...
-- Trigger to increment config_version on any data change
