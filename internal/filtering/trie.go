...
// For example, "ads.example.com" is stored as ["com", "example", "ads"].
//
// This allows matching "*.example.com" by checking if the domain path
// exists up to "example.com" with a wildcard flag.
//
// Thread-safe for concurrent reads after building. Use RWMutex for
// concurrent read/write access during runtime updates.
