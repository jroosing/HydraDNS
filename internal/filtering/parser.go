...
//
// Supported formats:
//   - FormatDomains: Plain list of domains, one per line
//   - FormatHosts: Hosts file format (IP address followed by domain(s))
//   - FormatAdblock: Adblock Plus format (||domain^ syntax)
//   - FormatAuto: Auto-detect the format (tries each in order)
type ListFormat int
