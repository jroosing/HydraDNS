...
type FilteringConfig struct {
	...
	LogAllowed       bool              `yaml:"log_allowed" mapstructure:"log_allowed"`
	WhitelistDomains []string          `yaml:"whitelist_domains" mapstructure:"whitelist_domains"`
	BlacklistDomains []string          `yaml:"blacklist_domains" mapstructure:"blacklist_domains"`
...
type BlocklistConfig struct {
	...
	Format string `yaml:"format" mapstructure:"format"` // "auto", "adblock", "hosts", "domains"
}
